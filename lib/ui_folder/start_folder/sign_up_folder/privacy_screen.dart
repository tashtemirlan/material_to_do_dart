...
import '../../../data_class_folder/login_sign_up_folder/privacy_data_class.dart';
...
class PrivacyScreenState extends State<PrivacyScreen> {
  ...
  Future<void> getPrivacy() async{
    ...
    //set Dio response =>
    try{
      final respose = await dio.get(endpoints.privacyGetEndpoint);
      if(respose.statusCode == 200){
        final result = privacyDataClassFromJson(respose.toString());
